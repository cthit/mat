...
import OpenStatus from "../restaurant/open-status";
import PhoneNumber from "../restaurant/phone-number";
import RestaurantRating from "../restaurant/restaurant-rating";
import GoogleMapsLink from "../restaurant/google-maps-link";
import { DigitLayout, DigitText } from "@cthit/react-digit-components";
import OpeningHours from "../restaurant/opening-hours";
import styled from "styled-components";
import useCurrentWeekday from "../restaurant/use-current-weekday/use-current-weekday";
